...
import { useRatingResultsMutation } from "../../redux/services/rating.service";
...
const Rating = ({ setPayload, CleanFilter }) => {
  const [anchorEl, setAnchorEl] = useState(null);
  const [filterValue, setFilterValue] = useState("");
  const [calender, setCalender] = useState(null);
  const [ratingResults] = useRatingResultsMutation();
      ...
      >
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          <Typography sx={{ textAlign: "center", color: "#9277F7" }}>
            Rating Data from Start date to End date
          </Typography>
          <DemoContainer
